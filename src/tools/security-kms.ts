...
export function registerKmsTools(server: McpServer, client: NcloudClient): void {
  ...
  defineTool(
    ...
    async (params) => {
      return client.requestRaw("GET", `/kms/v1/keys/${params.keyTag}`);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.requestRaw("POST", `/kms/v1/keys/${params.keyTag}/enable`);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.requestRaw("POST", `/kms/v1/keys/${params.keyTag}/disable`);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.requestRaw("POST", `/kms/v1/keys/${params.keyTag}/versions/${params.version}/enable`);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.requestRaw("POST", `/kms/v1/keys/${params.keyTag}/versions/${params.version}/disable`);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.requestRaw("GET", `/kms/v1/keys/${params.keyTag}/versions`);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.requestRaw("POST", `/kms/v1/keys/${params.keyTag}/cancel-deletion`);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.requestRaw("POST", `/kms/v1/keys/${params.keyTag}/enable-auto-rotation`);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.requestRaw("POST", `/kms/v1/keys/${params.keyTag}/disable-auto-rotation`);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.requestRaw("POST", `/kms/v1/keys/${params.keyTag}/token-generator`);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.requestRaw("GET", `/kms/v1/keys/${params.keyTag}/token-generator`);
    }
  );
