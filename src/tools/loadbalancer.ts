...
export function registerLoadBalancerTools(server: McpServer, client: NcloudClient): void {
  ...
  defineTool(
    ...
    async (params) => {
      return client.request("/vloadbalancer/v2/getLoadBalancerInstanceList", params);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.request("/vloadbalancer/v2/getLoadBalancerInstanceDetail", params);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.request("/vloadbalancer/v2/changeLoadBalancerInstanceConfiguration", params);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.request("/vloadbalancer/v2/setLoadBalancerDescription", params);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.request("/vloadbalancer/v2/setLoadBalancerInstanceSubnet", params);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.request("/vloadbalancer/v2/changeLoadBalancerListenerConfiguration", params);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.request("/vloadbalancer/v2/getLoadBalancerRuleList", params);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.request("/vloadbalancer/v2/addLoadBalancerListenerCertificate", params);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.request("/vloadbalancer/v2/getLoadBalancerListenerList", params);
    }
  );
  ...
  defineTool(
    ...
    async (params) => {
      return client.request("/vloadbalancer/v2/createLoadBalancerListener", params);
    }
  );
