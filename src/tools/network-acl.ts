...
export function registerNetworkAclTools(server: McpServer, client: NcloudClient): void {
  ...
  defineTool(
    ...
    {
      vpcNo: z.string({ required_error: requiredError("vpcNo") }).describe("VPC number to create Network ACL in"),
      networkAclName: z.string().max(30, {
        message: maxLenMessage("networkAclName", 30),
  ...
  defineTool(
    ...
    {
      networkAclNo: z.string({ required_error: requiredError("networkAclNo") }).describe("Network ACL number"),
      priority: z.number({ required_error: requiredError("priority") }).describe("Rule priority (1-199)"),
      protocolTypeCode: z.string({ required_error: requiredError("protocolTypeCode") }).describe("Protocol type code (TCP, UDP, ICMP)"),
      ruleActionCode: z.string({ required_error: requiredError("ruleActionCode") }).describe("Rule action (ALLOW or DROP)"),
  ...
  defineTool(
    ...
    {
      networkAclNo: z.string({ required_error: requiredError("networkAclNo") }).describe("Network ACL number to assign"),
      subnetNo: z.string({ required_error: requiredError("subnetNo") }).describe("Subnet number to assign the Network ACL to"),
    },
    async (params) => {
  ...
  defineTool(
    ...
    {
      networkAclNo: z.string({ required_error: requiredError("networkAclNo") }).describe("Network ACL number to delete"),
  ...
  defineTool(
    ...
    {
      networkAclNo: z.string({ required_error: requiredError("networkAclNo") }).describe("Network ACL number"),
      priority: z.number({ required_error: requiredError("priority") }).describe("Rule priority to remove"),
      protocolTypeCode: z.string({ required_error: requiredError("protocolTypeCode") }).describe("Protocol type code (TCP, UDP, ICMP)"),
      ruleActionCode: z.string({ required_error: requiredError("ruleActionCode") }).describe("Rule action (ALLOW or DROP)"),
  ...
  defineTool(
    ...
    {
      networkAclNo: z.string({ required_error: requiredError("networkAclNo") }).describe("Network ACL number"),
      networkAclDescription: z.string({ required_error: requiredError("networkAclDescription") }).describe("New description for the Network ACL"),
    },
    async (params) => {
  ...
  defineTool(
    ...
    {
      networkAclDenyAllowGroupNo: z.string({ required_error: requiredError("networkAclDenyAllowGroupNo") }).describe("Deny-Allow Group number to query"),
    },
    async (params) => {
  ...
  defineTool(
    ...
    {
      vpcNo: z.string({ required_error: requiredError("vpcNo") }).describe("VPC number to create the Deny-Allow Group in"),
  ...
  defineTool(
    ...
    {
      networkAclDenyAllowGroupNo: z.string({ required_error: requiredError("networkAclDenyAllowGroupNo") }).describe("Deny-Allow Group number to delete"),
      confirm: z.boolean().optional().default(false).describe("Must be true to actually execute the destructive operation"),
    },
    async (params) => {
      const { confirm, ...apiParams } = params;
  ...
  defineTool(
    ...
    {
      networkAclDenyAllowGroupNo: z.string({ required_error: requiredError("networkAclDenyAllowGroupNo") }).describe("Deny-Allow Group number"),
  ...
  defineTool(
    ...
    {
      networkAclDenyAllowGroupNo: z.string({ required_error: requiredError("networkAclDenyAllowGroupNo") }).describe("Deny-Allow Group number"),
      networkAclDenyAllowGroupDescription: z.string({ required_error: requiredError("networkAclDenyAllowGroupDescription") }).describe("New description for the Deny-Allow Group"),
    },
    async (params) => {
